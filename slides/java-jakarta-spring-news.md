...
# Merre tart a Java, Jakarta EE és a Spring 2026&#8209;ban?
...
- JavaOne konferencia, [Keynote](https://www.youtube.com/watch?v=3fLCOqpIfI0&t=8354s) (2026. március 17-19.)
- [Spring I/O](https://www.youtube.com/watch?v=qxrGs5p5PXI&list=PLe6FX2SlkJdQZ3N0SW9Abo4cN7eO5dU-U) (2026. április 14-15.)
- [IntelliJ IDEA Conf](https://www.youtube.com/watch?v=fi_mGfiBs4M&list=PLPZy-hmwOdEWItbnW5iDHlXLwnq5RTVYi&index=1) (2026. szeptember 8-9.)
    - 12 előadásból 7 erősen AI fókuszú, maradék Maven, Jakarta EE, Quarkus, stb.
...
- [The Java Story | JTechLog bemutató](https://www.jtechlog.hu/2026/07/12/the-java-story.html)
- Említett nyelvi újdonságok: Lambda, virtuális szálak
- Említett eszközök:  Tomcat, IntelliJ IDEA, Kafka, Maven, Eclipse Foundation, Gradle, Spring, Elastic, Hibernate
- Két főbb projekt: Project Valhalla, Project Panama
- Szereplők: Java közeli személyek és cégek, Netflix vezető szoftvermérnöke
...
* Jön: Java 27 - 2026. szeptember 15., 15:00 UTC [Java 27 Launch Livestream](https://www.youtube.com/live/4V2jooUo8O0)
* Tanulhatóság
* Fejlesztői kényelem
...
* Neve abból származik, hogy két fontos dolgot köt össze, az Atlanti- és a Csendes-óceánt
* Foreign libraries
* Vector API
    * Ugyanaz a műveletet több adaton egyszerre
    * Adatpárhuzamos (SIMD) számítások
    * CPU vektorutasítások (pl. AVX, SSE)
...
- Jakarta EE 8 (2019): Java SE 8, teljes kompatibilitás, nyílt forráskód (TCK-t is beleértve)
- Jakarta EE 9 (2020): csomagátnevezés `javax`-ról `jakarta`-ra
- Jakarta EE 10 (2022): Java SE 11, de használható 17-tel is, Jakarta EE Core Profile, CDI Lite
- Jakarta EE 11 (2025): Java SE 17, de használható 21-gyel is, Records, Jakarta Data

---

## Jakarta EE Core Profile

REST-alapú microservice-ek fejlesztéséhez

<img src="images/Jakarta-EE-11-Core-Profile.avif" width="600px" />
...
* Resolve at build time, nincs reflection, így a GraalVM tud dolgozni
...
<img src="images/jakarta-ee-11-web.png" width="600px" />

* Narancssárga: új, kék: frissített

---

## Concurrency 3.1

- Virtual thread integráció

---

## Jakarta EE 12

- Java 21, de használható 25-tel is
- Query 1.0: oo query language for Java
- NoSQL 1.1 
...
- [Jakarta Agentic Artificial Intelligence](https://jakarta.ee/specifications/agentic-ai/)
- Jakarta EE 12-ben még nem jön
- Addig is [OmniHai - A unified Java AI utility library, with first-class Jakarta EE and MicroProfile integration.](https://omnihai.org/)

---

## MicroProfile

- MicroProfile 7.1 (2025. június 17.)
- Jakarta EE 10 Core Profile-ra épít

---

## MicroProfile

![MicroProfile](images/microprofile.png)

---

## Érdekes projekt

- [Vidocq](https://vidocq.dev/)
- Jakarta EE Core Profile and MicroProfile implementáció
- Nyílt forráskódú
- Nincs külső függősége
- Java 25
- JPMS
- Virtual thread first
- CDI specifikáció alkotói közül ketten
- Codeberg kódtárolón, infrastruktúráját a németországi Codeberg e.V. nonprofit szervezet működteti az EU-ban
- Specifikációk és TCK alapján AI által generált
- 180_000 sor Java kód, 5_650 lefutott TCK teszt
- 2000-es évek unalmas szabványosítási munkája teszi lehetővé a 2026-os kísérletet

---

## Spring Framework 7 és Spring Boot 4
...
* Spring Data JPA
    ...
    * AOT repository
    * [Spring Data JPA és forráskód generálás | JTechLog](https://www.jtechlog.hu/2026/07/12/spring-data-jpa-aot.html)
* Spring Security 7
...
* Spring gRPC support
* RabbitMQ AMQP 1.0
* Observability, OpenTelemetry improvements
